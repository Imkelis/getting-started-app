...
def hello2():
    ...
    return f"<body style='background-color: #D15830;'><h1 style='color: blue;'>Say Hello hello my name is ignas from Dockerised Flask</h1><img src='{image_url}'/>" + nav_links + "</body>"
